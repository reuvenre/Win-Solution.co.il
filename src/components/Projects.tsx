...
const projects = [
  {
    name: 'NEXLIFY',
    category: 'אוטומציית שיווק שותפים AI',
    description:
      'מערכת אוטומציה מלאה לשיווק שותפים — מגלה מוצרים חמים, כותבת קופי מוכר עם AI, ומפרסמת ל-5 פלטפורמות תוך מדידת כל קליק ועמלה.',
    results: ['טייס אוטומטי — מגילוי מוצר ועד פרסום', 'פרסום ל-5 פלטפורמות בו-זמנית', 'מדידת עמלות עד רמת הפוסט הבודד'],
    tags: ['AI', 'אוטומציה', 'Multi-Channel'],
  ...
  {
    name: 'CLICKLEAD',
    category: 'דפי נחיתה ולידים לקהילות',
    description:
      'מערכת שהופכת קליקים ממודעות לחברי קהילה — דף נחיתה ממותג תוך דקות, איסוף לידים עם מעקב מלא על המשפך, ודוח ROI שמראה כמה החזיר כל שקל פרסום.',
    results: ['דף נחיתה חי בדקות — עם קופי AI וטסטים A/B', 'מעקב הצטרפות אמיתי לקבוצה, לא רק קליקים', 'דוח ROI — עלות מול עמלות עד רמת הקמפיין'],
    tags: ['Leads', 'AI', 'Meta Ads'],
